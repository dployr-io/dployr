...
<div class="relative border-b border-gray-700 px-6 py-3">
  <div class="flex items-center">
    ...
    <div class="text-sm flex-1 flex justify-center">
      <nav class="flex items-center font-semibold overflow-hidden">
        ...
        <a href="#" class="flex gap-1 nav-tab whitespace-nowrap items-center"
        class:active={selectedSection === 'Resources'}
        ...
        <a href="#" class="flex gap-1 nav-tab whitespace-nowrap items-center"
          class:active={selectedSection === 'Domains'}
        ...
        <a href="#" class="flex gap-1 nav-tab whitespace-nowrap items-center"
          class:active={selectedSection === 'Console'}
          on:click={() => selectSection('Console')}
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
    ...
    <!-- Invisible “spacer” matching the back button -->
    <!-- so the nav stays perfectly centered -->
    <div class="w-[calc(4rem+theme(spacing.2))] flex-none" />
  </div>
</div>

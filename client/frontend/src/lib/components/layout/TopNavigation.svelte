      ...
      {#if $showProfileDropdown}
        <div class="absolute right-4 top-14 z-50 bg-white dark:bg-stone-900 border border-gray-300 dark:border-stone-700 rounded-lg shadow-lg min-w-[220px]"> 
          <div class="p-2 flex flex-col gap-2">
            <button 
              class="group gap-1 flex items-center w-full px-3 py-1 rounded app-button-ghost text-left group-hover:text-white group-active:text-white"
              on:click|stopPropagation={toggleAccountDropdown}
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-gray-600 dark:text-gray-200 group-hover:text-white group-active:text-white">

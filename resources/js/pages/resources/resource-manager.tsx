...
import { resourceManagerIndex } from '@/routes';
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex w-full flex-col gap-6 px-9 py-6">
                    <div className="flex flex-col gap-1">
                        <p className="text-2xl font-black">Resource Manager</p>
                        <p className="text-sm font-normal text-muted-foreground">Manage all your services and resources</p>
                    </div>

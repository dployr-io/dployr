...
export default function ProjectCard(project: Project) {
    return (
       <div
            key={project.id}
            className="rounded-xl border border-sidebar-border/70 p-4 hover:cursor-pointer hover:border-muted-foreground dark:hover:border-muted-foreground  h-28 flex flex-col dark:border-sidebar-border"
        >
            <div className="flex gap-2 mb-2">
                <img className="h-6 w-6 bg-gra rounded-full flex-shrink-0" 
